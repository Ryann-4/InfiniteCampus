(function () {
  ...
  const encryptedApiKey = "QWl6YVN5QWd6NjZYNW9RRzZKdnJKamlWRVd3VEtJNFRsZnhBNHF3"; // Base64 of actual API key
  ...
  window.API_KEY = decryptBase64(encryptedApiKey); // Decrypted Firebase API Key
})();
